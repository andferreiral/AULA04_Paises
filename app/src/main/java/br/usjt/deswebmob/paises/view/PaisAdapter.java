...
import static br.usjt.deswebmob.paises.R.drawable.bandeira;
...
public class PaisAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Drawable drawable = br.usjt.deswebmob.paises.view.Util.getDrawable(activity, paises[position].getCodigo3().toLowerCase());
        if(drawable == null){
